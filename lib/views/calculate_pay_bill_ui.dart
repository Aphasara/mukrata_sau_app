...
class _CalculatePayBillUIState extends State<CalculatePayBillUI> {
  ...
  //ตัวแปรเก็บรายการที่เลือกจาก dropdown
  ...
  //สร้างตัวแปรเก็บสถานะผู้ใหญ่และเด็ก
          ...
          child: Center(
            child: Column(
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    //เปิดกล้องแล้วเอารูปที่ถ่ายมาแสดงแทน
                    getImageFromCamera();
                  },
                ...
                Row(
                  children: [
                    Radio(
                      value: 2, //radio value ห้ามซ้ำกัน
                      groupValue: waterStatus,
                      onChanged: (paramValue) {
                        setState(() {
                          waterStatus = paramValue!;
                    ...
                    Expanded(
                      ...
                      child: ElevatedButton.icon(
                        onPressed: () {
                          ...
                          //เปิดไปยังหน้าแสดงผล โดยส่งรูป จำนวนคน น้ำ และเงินที่ต้องจ่ายไปแสดง
                          Navigator.push(
                            context,
                            MaterialPageRoute(
